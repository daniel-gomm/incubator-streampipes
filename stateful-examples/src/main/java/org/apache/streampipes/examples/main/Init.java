...
import org.apache.streampipes.examples.pe.processor.counter.CounterController;
import org.apache.streampipes.messaging.jms.SpJmsProtocolFactory;
import org.apache.streampipes.messaging.kafka.SpKafkaProtocolFactory;

import org.apache.streampipes.examples.config.Config;
import org.apache.streampipes.examples.pe.processor.aggregator.AggregatorController;

public class Init extends StandaloneModelSubmitter {

  public static void main(String[] args) throws Exception {
    DeclarersSingleton.getInstance()
            .add(new AggregatorController())
