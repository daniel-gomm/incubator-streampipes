...
import static org.apache.streampipes.example.config.ConfigKeys.*;
...
public enum Config implements PeConfig {
  ...
  private final static String SERVICE_ID= "pe/org.apache.streampipes.example";

  Config() {
    config = SpConfig.getSpConfig("pe/org.apache.streampipes.example");
