...
public class ExampleController extends StatefulStandaloneEventProcessingDeclarer<ExampleParameters> {

	private static final String EXAMPLE_KEY = "example-key";

	@Override
	public DataProcessorDescription declareModel() {
		return ProcessingElementBuilder.create("org.apache.streampipes.example.pe.processor.example")
